...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sqlLlamarLibro = "SELECT * FROM libros WHERE id_libro = $id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sqlActualizarLibro = "UPDATE libros SET titulo='$titulo', id_autor='$idAutor', id_editorial='$idEditorial', id_categoria='$idCategoria', año_publicacion='$añoPublicacion', stock='$stock' WHERE id_libro=$id";
...
<body>
    ...
    <div class="conteiner">
        <div class="form-conteiner">
            <h1>Editar Libro</h1>
            <form action="edita_libros.php" method="POST">
